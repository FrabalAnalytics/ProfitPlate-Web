-- Supplier delivery receipt is an Inventory/Store control, not a Procurement
-- self-confirmation step. This keeps purchase order drafting and goods receipt
-- independent, and protects partially received PO lines from duplicate posting.
