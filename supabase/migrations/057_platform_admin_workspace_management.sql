-- Platform admins need controlled restaurant-entity management without being
-- inserted into each restaurant workspace. Keep these actions narrow and
-- auditable; deeper support tools such as impersonation should be a later,
-- separately-audited feature.
