-- Restore the Finance approval posting function used by approve_dashboard_request.
-- Some live workspaces were missing this RPC, which prevented approved stock
-- counts from becoming stock count lines, variance records, and inventory
-- balances.
